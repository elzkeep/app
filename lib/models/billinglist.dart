...
class Billinglist { 
  ...
  Map<String, dynamic> toJson() =>
      { 'id': id,'price': price,'status': status.index,'giro': giro.index,'billdate': billdate,'company': company,'building': building,'date': date,'buildingname': buildingname,'billingname': billingname,'billingtel': billingtel,'billingemail': billingemail };

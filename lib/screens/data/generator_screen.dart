...
class GeneratorScreen extends CWidget {
      ...
      child: CFixedBottom(children: [
        SingleChildScrollView(
          ...
          CRow(margin: const EdgeInsets.only(top: 10), gap: 10, children: [
            Expanded(child: roundBorder(CText('저압설비'))),
            Expanded(child: roundBorder(CText('고압설비'))),
          ]),
          CRow(margin: const EdgeInsets.only(top: 10), gap: 10, children: [
            Expanded(child: roundBorder(CText('변압설비'))),
            Expanded(child: roundBorder(CText('부하설비'))),
          ]),
          CRow(margin: const EdgeInsets.only(top: 10), gap: 10, children: [
            Expanded(child: roundBorder(CText('발전설비'))),
            Expanded(child: roundBorder(CText('기타안전설비'))),
          ]),
          CRow(margin: const EdgeInsets.only(top: 10), gap: 10, children: [
            Expanded(child: roundBorder(CText('태양광 발전설비'))),
            Expanded(child: roundBorder(CText('전기차충전기'))),
          ]),
          const SizedBox(height: 20),
          CTextField(
            text: '종합 검토 의견',
